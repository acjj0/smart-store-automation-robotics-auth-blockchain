...
/**
 * The StoreModelServiceException is returned from the StoreModelService methods in
 * response to an error condition. The StoreModelServiceException captures the command that
 ...
 */
public class StoreModelServiceException {
    /**
     ...
     */
    public StoreModelServiceException(String command, String reason, String lineNumber)
    {
